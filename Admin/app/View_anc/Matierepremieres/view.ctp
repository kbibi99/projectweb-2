                            ...
                            <div <?php echo $disp1?> class='form-group'>	
                             ...
                             <div class='form-group' <?php echo $disp1?>>	
                                 <label class='col-md-2 control-label'><?php echo __('Taille'); ?></label>	
                                  ...
                                  <div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' value='<?php echo $matierepremiere['Taille']['name']; ?>'>
                                  </div>
                            </div>
                             <div <?php echo $disp1?> class='form-group'>	
                                 <label class='col-md-2 control-label'><?php echo __('Famille Production'); ?></label>	
                                  	
                                  
                                 <div class='col-sm-10'><input type='<?php echo $disp1?>'  class='form-control' readonly='readonly' class='input' value='<?php echo h($matierepremiere['Famille']['name']); ?>'>
