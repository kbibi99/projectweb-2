    ...
    '<tr bgcolor="'.$color.'" align="center">    
      ...
      $tbl .=  
       ' 
           ...
           <tr bgcolor="#FFFFFF" align="center">  
                <td colspan="7" align="right" width="89%"   ><strong>Remise en '.$typp.'</strong></td>
                <td  align="right" width="11%"><strong>'.$remisex.'</strong></td>
            </tr>
            <tr bgcolor="#FFFFFF" align="center">  
                <td colspan="7" align="right" width="89%"   ><strong>Net à Payer</strong></td>
                <td  align="right" width="11%"><strong>'.$netapayer.'</strong></td>
            </tr>';
