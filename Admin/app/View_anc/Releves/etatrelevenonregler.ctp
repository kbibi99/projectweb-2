...
<div class="col-md-12" >
		...
		echo $this->Form->input('marque_id',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','empty'=>'Veuillez choisir') );
              ...
              <?php  echo $this->Form->input('reg',array('label'=>'Regler/NON','value'=>1,'div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','empty'=>'Veuillez choisir') );?>
                </div>
	</div>
  <div class="col-md-6"> 
       	<?php 
...
<div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Etat Releves Non Regler'); ?></h3>
                                </div>
                                <div class="panel-body">
	...
	<tr>
            ...
            <td width="50%" align="center"><strong><?php echo ('Contact'); ?></strong></td>
	         
            <td width="50%" align="center"><strong><?php echo ('Montant'); ?></strong></td>
	...
	<?php 
        ...
        foreach (@$releves as $relefe):
            ...
            ?>
	<tr>
             <td   align="center"><?php echo h($relefe['Relefe']['Client']); ?></td>
             <td  align="center"><?php echo h($relefe[0]['Montant']); ?></td>
	</tr>
