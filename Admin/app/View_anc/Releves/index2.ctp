...
<!--		<th><?php echo ('Client'); ?></th>-->
	...
	<?php $solde=0; $totremise=0;
        ...
        foreach (@$releves as $relefe): 
            ...
            ?>
	<tr>
		<td><?php echo h($relefe['Relefe']['Type']); ?></td>
		<td><?php 
...
<!--		<td><?php echo h($relefe['Relefe']['Client']); ?></td>-->
		<td><?php echo h($relefe['Relefe']['Contact']); ?></td>
		<td><?php echo h($relefe['Relefe']['Montant']); ?></td>
		<td><?php echo h($relefe['Relefe']['Remise']); ?></td>
                <td><?php echo h($solde); ?></td>
...
<?php endforeach; 
        ...
        <tr>
            ...
            <td colspan="4" align="right">Total Remise</td>
            <td><?php echo h($totremise); ?></td>
            <td></td>
        </tr>
                          </tbody>
	</table>
