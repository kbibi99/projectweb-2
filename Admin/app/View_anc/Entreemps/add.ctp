    ...
    <div class="col-md-12" >
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo __('Ajout Entrée MP'); ?></h3>
            </div>
                                                ...
                                                <tr  class="type" style="display: none" >
                                                    <td style="border: 1px solid #ddd !important;">
                                                        ...
                                                        <div id="divart0" index="0" champ='divart' table="">
                                                            <select  name="data[Lignempe][0][matierepremiere_id]" table="Lignempe" champ="matierepremiere_id" index="0" class="cal_prix mati"  id="matierepremiere_id0"  tabindex="0" onchange="cal_prix(0, 0)" > 
                                                            </select> 
                                                        </div> 
                                                    </td> 
                                                    <td style="border: 1px solid #ddd !important;">
                                                        <input  name="data[Lignempe][0][colis]" table="Lignempe" champ="colis" index="0" class="form-control cal_prix rmv" id="colis0"/>
                                                    </td>
                                                    <td style="border: 1px solid #ddd !important;">
                                                        <input  name="data[Lignempe][0][qte]" table="Lignempe" champ="qte" index="0" class="form-control cal_prix rmv" id="qte0"/>
                                                    </td>
                                                    <td style="border: 1px solid #ddd !important;">
                                                        <input  name="data[Lignempe][0][Num_lot]" table="Lignempe" champ="Num_lot" index="0" class="form-control" id="Num_lot0"/>
                                                    </td>
                                                    <td style="border: 1px solid #ddd !important;"> 
                                                        <input  name="data[Lignempe][0][ttc]" table="Lignempe" champ="ttc" index="0" class="form-control cal_prix rmv" id="ttc0"/>
                                                    </td>
                                                    <td style="border: 1px solid #ddd !important;">
                                                        <div  table="Lignempe" champ="total" index="0" id="total0"  class="total">0 </div>
                                                    </td>
                                                    <td style="border: 1px solid #ddd !important;">
                                                        <i index="0"  class="fa fa-times sup" style="color: #c9302c;font-size: 22px;"/> 
                                                            <input  name="data[Lignempe][0][sup]" table="Lignempe" champ="sup" index="0" class="form-control cal_prix" id="sup0"  style="display: none"/>
                                                    </td>
                                                </tr> 
                                            </tbody>  
                                            <tfoot>
