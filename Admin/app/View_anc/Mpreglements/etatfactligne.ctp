        ...
        ?>
                ...
                <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                ...
                                                <a href="<?php echo $this->webroot;?>Mpreglements/etatfactligne" class="btn btn-primary">Afficher Tout</a>
             <a  onClick="flvFPW1(wr+'Mpreglements/imprimeretatfactligne?Numero=<?php echo @$Numero;?>&Date_debut=<?php echo @$Date_debut;?>&Date_fin=<?php echo @$Date_fin;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
<?php 
// debug($mar);
...
<?php echo $this->Form->end();?>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Etat des BLs / FACT (avec ligne)'); ?></h3>
                                </div>
                                <div class="panel-body">
	...
	<?php 
        ...
        foreach ($mpreglements as $mpreglement): 
            ...
            foreach ($lignefacturefournisseurs as $lignefacturefournisseur){
                ...
                if($numero1==$numero2){
                    $ligne=array();
                    //debug($lignefacturefournisseur);die;
                    foreach($lignefacturefournisseur['Facturefournisseur']['Lignefacturefournisseur'] as $f=>$ff){
                          //debug($ff);die;
                           //$ligne[$f]['designation']=$lignefacturefournisseur['Mpfournisseur']['code'];
                  ...
                  $espece=0;$cheque=array();$traite=array();  $row=1;     
             foreach($mpreglement['Mpreglement']['Mppiecereglement'] as $j=>$pp){
                
//                 $num_reg=$pp['Mpreglement']['num'];
//                 if($num_reg==$num_reg_anc){
//                     $espece="";
//                     $cheque="";
//                     $traite="";
//                     $row=$row++;
	...
	<tr>
		...
		<td align="center"><?php echo h($mpreglement['Facturefournisseur']['Numero']) ?></td> <!-- h($mpreglement['Mplignereglement'][0]['Facturefournisseur']['Numero']);-->
                <td align="center" >
                    ...
                    <?php foreach($ligne as $l){?>
                        <tr>
                                    <td align="center"><?php echo $l['designation']; ?></td>
                                    <td align="center"><?php echo $l['Qte']; ?></td>
                                    <td align="center"><?php echo $l['Total_HT']; ?></td>
                        </tr>
                   <?php } ?>
                    </table><?php }?>
                ...
                <td align="center"><?php echo h($mpreglement['Facturefournisseur']['Total_TTC']); ?></td>
