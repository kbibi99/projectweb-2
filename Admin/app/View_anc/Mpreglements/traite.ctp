  ...
  <div class="col-md-6"> 
                ...
                <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                <button type="submit" class="btn btn-primary">Afficher</button> 
                                                 <a href="<?php echo $this->webroot;?>mpreglements/traite" class="btn btn-primary">Afficher Tout</a>
    ...
    default:
        $this->request->data['Mppiecereglement']['situation_id']="4";
                                ...
                                ?>
                        <a onClick="flvFPW1(wr+'mpreglements/imp_traite?fournisseur_id='+<?php echo $this->request->data['Mppiecereglement']['fournisseur_id'];?>+'&situation_id='+<?php echo $this->request->data['Mppiecereglement']['situation_id'];?>+'&Date_debut='+<?php echo $date1; ?>+'&Date_fin='+<?php echo $date2; ?>+'&Date_deb='+<?php echo $datea; ?>+'&Date_fn='+<?php echo $dateb; ?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" >
