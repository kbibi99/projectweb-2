...
<!--Left navigation section start-->
  <?php if (in_array(strtolower($this->params['controller']), array('inventairefamilles','stocks','articles','inventaires','ligneproductions','tailles', 'familles','modeles','couleurs','references','types','depots','stockdepots','mouvementstocks'))): ?>
 ...
 <?php if (in_array(strtolower($this->params['controller']), array('transferecommandebls','caissements','alimentationcaisses','releves','ventes','banques','piecereglements','pieces','clients', 'boncommandes', 'bonlivraisons','devis','factures','reglements','collections', 'entreecaisses', 'sortiecaisses', 'especes'))): ?>
                ...
                <?php endif; ?>
<?php if (in_array(strtolower($this->params['controller']), array('prods','productions','productionfamilles'))): ?>
                    <?php echo $this->element('production'); ?> 
                <?php endif; ?>
<?php if (in_array(strtolower($this->params['controller']), array('Mpreglements','mpreglements','achats','mppiecereglements','matierepremieres','unites','fournisseurs','mpfournisseurs','famillefournisseurs','deposits','inventories','lineinventories','stockmatierepremieres', 'emplacements', 'colors', 'families', 'machines', 'typestocks', 'types', 'colors',
