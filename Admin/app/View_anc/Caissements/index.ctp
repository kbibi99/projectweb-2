...
<div class="row">
     <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('ENTREE'); ?></h3>
                                </div>
                                <div class="panel-body">
	...
	<?php $solde=0; $totREG=0; $totALM=0;$totEnC=0;
        ...
        foreach (@$caissements as $caissement): 
            ...
            if(@$caissement['Caissement']['Type']=='Alimentation'){
                ...
                $AlmOB=$caissement['Caissement']['observation'];
                $cadreB='style="background-color:#00BFEF;"';
            }
	...
	<tr>
                ...
                echo $Date;
                ?></td>
                <td <?php echo $cadreB ?>align="center"><?php echo $AlmOB; echo "  " ;echo h($caissement['Caissement']['Client']); ?></td>
...
<div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('SORTIE'); ?></h3>
                                </div>
                                <div class="panel-body">
                                    <div class="ls-editable-table table-responsive ls-table">
                  <table class="table table-bordered table-striped table-bottomless" id="">
	...
	<?php $solde=0; $totDec=0; 
        ...
        foreach (@$decaissements as $decaissement): 
            if(@$decaissement['Decaissement']['Type']=='SRT'){
                ...
                $Dobsr=$decaissement['Decaissement']['observation'];
                $cadreB='';
            }
	...
	<tr>
                ...
                echo $Date;
                ?></td>
                <td <?php echo $cadreB ?>align="center"><?php echo $Dobsr ; ?></td>
...
<div class="row">
    ...
    <div class="col-md-6" style=" float: left !important; <?php if($totEnC-$totDec<0) {?>display: none;<?php } ?>">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Solde Créditeur'); ?></h3>
                                </div>
                                <div class="panel-body">
                                    <div class="ls-editable-table table-responsive ls-table">
                  <table class="table table-bordered table-striped table-bottomless" id="">
    ...
    <div class="col-md-6" style="float: right !important; <?php if($totEnC-$totDec>=0) {?>display: none;<?php } ?>">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Solde Debiteur'); ?></h3>
                                </div>
                                <div class="panel-body">
                                    <div class="ls-editable-table table-responsive ls-table">
                  <table class="table table-bordered table-striped table-bottomless" id="">
