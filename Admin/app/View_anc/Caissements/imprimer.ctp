...
<div>
    ...
    <table style="width: 100%;">
        ...
        <tr style="height: 40px ;">
            <td style="height: 90px ;width: 10%;"><strong style="font-family:Arial, Helvetica, sans-serif;font-size:22px"><?php echo $paie['Moi']['name'];?></strong></td>
            <td style="height: 90px ;width: 40%;"><strong style="font-family:Arial, Helvetica, sans-serif;font-size:22px"><?php echo $paie['Annee']['name'];?></strong></td>
        ...
        <tr  style="height: 40px ;"> 
            <td style=""></td>
            <td style=""></td>
            <td style="" align="right"><strong style="font-family:Arial, Helvetica, sans-serif;font-size:22px"><?php echo $paie['Paie']['Salairebase'];?></strong></td>
            <td style="" align="right"><strong style="font-family:Arial, Helvetica, sans-serif;font-size:22px"><?php echo 'المرتب الشهري';?></strong></td>
        </tr>  
...
<!--    <tr>
    ...
    <tr  style="height: 50px ;">   
        ...
        <td align="center" style="font-family:Arial, Helvetica, sans-serif;font-size:20px;border-left:2px solid black;border-bottom:2px solid black;" align="center"><b><?php echo'المبلغ المتبقي' ?></b></td>
     ...
     <tr  style="height: 50px ;">   
        ...
        <td align="center" style="font-family:Arial, Helvetica, sans-serif;font-size:20px;border-left:2px solid black;border-bottom:2px solid black;background-color:#98E3EB;" align="center"><b><?php echo 'المبلغ المدفوع';?></b></td>
        <td align="center" style="font-family:Arial, Helvetica, sans-serif;font-size:20px;border-left:2px solid black;"></td>
    </tr>
