...
<?php endforeach; 
        ...
        <tr>     
            ...
            <td  align="right"><?php echo h($totDec); ?></td>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Total'); ?></h3>
                                </div>
                                <div class="panel-body">
                                    <div class="ls-editable-table table-responsive ls-table">
                  <table class="table table-bordered table-striped table-bottomless" id="">
                      <thead>
                                   <?php if  ($totEnC-$totDec >0){
                                            $cadreB='style="background-color:#39FC03;"';
                                        }
                                        if  ($totEnC-$totDec <=0){
                                            $cadreB='style="background-color:#FC0303;"';
                                        }
                                        $tot=$totEnC-$totDec;
                                        $tot=sprintf('%.3f',$tot);
                                           ?>  
                                        <tr>
                                            <td>Total</td>
                                            <td <?php echo $cadreB ?>><?php echo  $tot;?></td>
