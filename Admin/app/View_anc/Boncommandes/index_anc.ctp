		...
		<td align="center">
			...
			<?php echo $this->Html->link("<button class='btn btn-xs btn-success'><i class='fa fa-search'></i></button>", array('action' => 'view', $boncommande['Boncommande']['id']),array('escape' => false)); ?>
			 <?php if(!in_array($boncommande['Boncommande']['id'],$collections)){ ?>
                            <?php echo $this->Html->link("<button class='btn btn-xs btn-warning'><i class='fa fa-edit'></i></button>", array('action' => 'edit', $boncommande['Boncommande']['id']),array('escape' => false)); ?>
			<?php echo $this->Html->link("<button class='btn btn-xs btn-warning'><i class='fa fa-dropbox'></i></button>", array('controller'=>'Collections','action' => 'add', $boncommande['Boncommande']['id']),array('escape' => false)); ?>
                            <?php echo $this->Form->postLink("<button class='btn btn-xs btn-danger'><i class='fa fa-trash-o'></i></button>", array('action' => 'delete', $boncommande['Boncommande']['id']),array('escape' => false,null), __('Veuillez vraiment supprimer cette enregistrement # %s?', $boncommande['Boncommande']['id'])); ?>
                         <?php } ?>
                </td>
                ...
                <td>
                    <?php if(!in_array($boncommande['Boncommande']['id'],$transferecommandebls) && in_array($boncommande['Boncommande']['id'],$collections)){ ?>
