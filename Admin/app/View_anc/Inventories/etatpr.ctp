...
<div class="row" >
    <div class="col-md-12" >
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo __('Etat de stock Pièces de rechange'); ?></h3>
            </div>
	...
	?></div><div class="col-md-6"><?php
		echo $this->Form->input('matierepremiere_id',array('empty'=>'veuillez choisir','div'=>'form-group','label'=>'Pièces de rechange','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','empty'=>'veuillez choisir'));
	?> 
              </div>      
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3"  >
                      ...
                      <a class="btn btn-primary" href="<?php echo $this->webroot;?>Inventories/etatpr"/>Afficher Tout </a>
                    <?php 
                                ...
                                ?>
                        <a onClick="flvFPW1(wr+'Inventories/imp_pr?dep='+<?php echo @$this->request->data['Inventory']['deposit_id'];?>+'&mat='+<?php echo $this->request->data['Inventory']['matierepremiere_id']; ?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" >
                                ...
                                <div class="tab-content tab-border">
                                    ...
                                    <div class="tab-pane fadein active" id="famille">
                                        <table class="table" id="table" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid #ddd !important;" align="center" >Prix Achat</td>
                                                    <td style="border: 1px solid #ddd !important;" align="center" >Emplacement</td>
                                       ...
                                       foreach ($stock as $key =>$value ) {
                                           $prixachat=$value['Matierepremiere']['prixachat'];
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #ddd !important;"><?php echo $value['Matierepremiere']['prixachat']?></td>
                                            <td style="border: 1px solid #ddd !important;" align="left"><?php echo @$emplacements[$value['Matierepremiere']['emplacement_id']]?></td> 
                                            <td style="border: 1px solid #ddd !important;" align="right"><?php echo $qte?></td>
                                            <td style="border: 1px solid #ddd !important;" align="right"><?php echo $total?></td>
                                        </tr>  
                                             <?php } } ?> 
                                            ...
                                            <tfoot>
                                               <tr>
                                                   <td colspan="4" style="border: 1px solid #ddd !important;" align="left" >Total</td>  
