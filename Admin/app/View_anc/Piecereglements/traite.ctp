...
?></select>
                 ...
                 <td>
                    ...
                    <option value="Escompte"    <?php if($piecereglement['Piece']['situation']=='Escompte'){?>selected="selected" <?php } ?>>Escompté</option>
