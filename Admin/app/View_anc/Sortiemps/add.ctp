...
<div class="row" >
    <input type="hidden" class="nompage" value="Sortiemp"/>
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Ajout Sortie MP'); ?></h3>
                                </div>
		...
		echo $this->Form->input('deposit_id',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'Dépôt','empty'=>'Veuillez choisir','value'=>$deposit_id) );
                                        ...
                                        <table class="table nolabel" id="table" style="width: 100%">
                                            <thead>
                                                <tr class='typee'>
                                                    ...
                                                    <td style="border: 1px solid #ddd !important;" align="center" style="width: 20%">Qte Colis</td>
                                                    <td style="border: 1px solid #ddd !important;" align="center" style="width: 20%">Qte Piéce</td> 
...
<td style="border: 1px solid #ddd !important;">
	...
	<?php	
                echo $this->Form->input('matierepremiere_id', array('label' => '', 'id' => 'matierepremiere_id0', 'name' => 'data[Lignempsorti][0][matierepremiere_id]','table'=>'Lignempsorti','champ'=>'matierepremiere_id','index'=>'0','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control uniform_select rmv aff_stk','empty'=>'Veuillez choisir') );
        ?>
        </select> 
    </div> 
</td> 
<td style="border: 1px solid #ddd !important;">
    <input   table="Lignempsorti" champ="stkcolis" index="0" class="form-control cal_prix rmv" id="stkcolis0" value="0" readonly/>
</td>
<td style="border: 1px solid #ddd !important;">
    <input   table="Lignempsorti" champ="stkqte" index="0" class="form-control cal_prix rmv" id="stkqte0" value="0" readonly/>
</td>
<td style="border: 1px solid #ddd !important;">
    <input  name="data[Lignempsorti][0][colis]" table="Lignempsorti" champ="colis" index="0" class="form-control cal_prix rmv test_stock" id="colis0"/>
</td>
<td style="border: 1px solid #ddd !important;">
    <input  name="data[Lignempsorti][0][qte]" table="Lignempsorti" champ="qte" index="0" class="form-control cal_prix rmv test_stock" id="qte0"/>
</td>
<td style="border: 1px solid #ddd !important;">
    <i index="0"  class="fa fa-times sup" style="color: #c9302c;font-size: 22px;"/> 
        <input  name="data[Lignempsorti][0][sup]" table="Lignempsorti" champ="sup" index="0" class="form-control cal_prix rmv" id="sup0"  style="display: none"/>
</td>
                                                </tr> 
                                            </tbody>  
