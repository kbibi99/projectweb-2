...
<li class="active">
    <a class="" href="<?php echo $this->webroot;?>Productionfamilles/etatproddatedetail">
        <i ><img src="<?php echo $this->webroot;?>assets/images/production.png" alt="" width="15px"/></i> <span>Etat Production / Jour Detail</span>
    </a>
</li>
<li class="">
