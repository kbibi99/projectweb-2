...
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Depots/index">
        <i ><img src="<?php echo $this->webroot;?>assets/images/depot.png" alt="" width="15px"/></i> <span>Depots</span>
    </a>
</li>
<?php }?>
        <?php
...
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Inventaires/index">
        <i ><img src="<?php echo $this->webroot;?>assets/images/depot.png" alt="" width="15px"/></i> <span>Inventaires</span>
    </a>
</li>
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Inventairefamilles/index">
        <i ><img src="<?php echo $this->webroot;?>assets/images/depot.png" alt="" width="15px"/></i> <span>Inventaires Familles</span>
    </a>
</li>
<?php }?>
        <?php
        ...
        ?>
<li class="">
    <a class="" href="<?php echo $this->webroot;?>ligneproductions/index">
        <i ><img src="<?php echo $this->webroot;?>assets/images/article.png" alt="" width="15px"/></i> <span>Réception des articles</span>
    </a>
</li>
        <?php } ?>
<!--<li>
