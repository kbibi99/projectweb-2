...
<ul class="social-icon">
    <li><a href="#"><i ><img src="<?php echo $this->webroot;?>assets/images/achat.png" alt="" width="20px"/></i></a></li>
...
<li>
    <a href="#">
        <i ><img src="<?php echo $this->webroot;?>assets/images/personnel.png" alt="" width="15px"/></i> <span>Personnel</span><span class="badge badge-red">4</span>
    </a>
    <ul>
        <li>
        ...
        <li><a href="<?php echo $this->webroot;?>Acomptes/index">Acompte</a>
        </li>
