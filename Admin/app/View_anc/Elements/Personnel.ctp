...
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Personnels/index">
        <i ><img src="<?php echo $this->webroot;?>assets/images/personnel.png" alt="" width="15px"/></i> <span>Personnel</span>
    </a>
</li>
<?php }
        ...
        ?>
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Acomptes/index">
        <i ><img src="<?php echo $this->webroot;?>assets/images/commande.png" alt="" width="15px"/></i> <span>Acompte</span>
    </a>
</li>
<?php }
        ...
        ?>
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Paies/index">
        <i ><img src="<?php echo $this->webroot;?>assets/images/personnel.png" alt="" width="15px"/></i> <span>Paie</span>
    </a>
</li>
<?php }
        $paie_index=  CakeSession::read('paie_index'); 
        ...
        ?>
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Paies/etatpaie">
        <i ><img src="<?php echo $this->webroot;?>assets/images/commande.png" alt="" width="15px"/></i> <span>Etat de Paie Des Personnels</span>
    </a>
</li>
<?php }
        $paie_index=  CakeSession::read('paie_index'); 
        ...
        ?>
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Paies/etatsolde">
        <i ><img src="<?php echo $this->webroot;?>assets/images/commande.png" alt="" width="15px"/></i> <span>Etat de solde</span>
    </a>
</li>
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Paies/etatpaiesalaire">
        <i ><img src="<?php echo $this->webroot;?>assets/images/commande.png" alt="" width="15px"/></i> <span>Etat de Paie Salaire</span>
    </a>
</li>
<?php }
...
<li class="">
    <a class="" href="<?php echo $this->webroot;?>Fonctions/index">
        <i ><img src="<?php echo $this->webroot;?>assets/images/personnel.png" alt="" width="15px"/></i> <span>Fonctions</span>
    </a>
</li>
        <?php }?>
<!--<li>
