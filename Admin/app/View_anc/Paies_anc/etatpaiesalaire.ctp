	...
	<?php 
        ...
        foreach ($paies as $paie): 
            ...
            if($paie['Personnel']['Type']=="ouvrier"){
               ...
               $Mjh=sprintf("%01.3f",round($paie['Paie']['Montantheur']));
               $nbrjhD=$paie['Paie']['Nbheurdimanche'];
               $MD=sprintf("%01.3f",round($paie['Paie']['Montanthdtaux']));
        ...
        <tr>
            <td style="display: none"><?php echo h($paie['Paie']['id']); ?></td>
                ...
                <td align="center" <?php echo $style ?> ><?php echo sprintf("%01.3f",round($paie['Paie']['Salairebase'])); ?></td>
                ...
                <td align="center" <?php echo $style ?> ><?php echo sprintf("%01.3f",round($paie['Paie']['acompte']));?></td>
                <td align="center" <?php echo $style ?> ><?php echo sprintf("%01.3f",round($paie['Paie']['Totalpaie']));?></td>
                <td align="center" <?php echo $style ?> ><?php echo sprintf("%01.3f",round($paie['Paie']['Donne']));?></td>
