 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   ...
   <tr bgcolor="#FFFFFF" align="center">
        ...
        foreach ($paies as $paie){
            ...
            $tot_dim=$tot_dim+sprintf("%01.3f",round($MD));
            $tot_mnt=$tot_mnt+sprintf("%01.3f",round($Mjh));
            $tot_b=$tot_b+sprintf("%01.3f",round($paie['Paie']['Salairebase']));
            $tot_sal=$tot_sal+sprintf("%01.3f",round($paie['Paie']['Totalpaie']));
            $tot_ac=$tot_ac+sprintf("%01.3f",round($paie['Paie']['acompte']));
            $tot_mp=$tot_mp+sprintf("%01.3f",round($paie['Paie']['Donne']));
