    ...
    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Consultation Collection'); //debug($collection['Lignecollection']);die;?></h3>
                                </div>
         ...
         <?php echo $this->Form->create('Collection',array('autocomplete' => 'off','class'=>'form-horizontal ls_form','id'=>'defaultForm','data-bv-message'=>'This value is not valid','data-bv-feedbackicons-valid'=>'fa fa-check','data-bv-feedbackicons-invalid'=>'fa fa-bug','data-bv-feedbackicons-validating'=>'fa fa-refresh')); ?>
           ...
           <div class="col-md-6">                         
			...
			<div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' class='input' value='<?php  echo h($collection['Collection']['numero']); ?>'>
                                 ...
                                 <label class='col-md-2 control-label'><?php echo __('Bon commande'); ?></label>	
                                  
			
                                  <div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' value='<?php echo $collection['Boncommande']['Numero']; ?>'>
                                  </div>
			...
			<div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo h($collection['Collection']['Date']); ?>'>
...
<?php echo $this->Form->end();?>
	...
	?>
                                        ...
                                        <table  class="table table-bordered table-striped table-bottomless" id="ls-editable-table">
                                            ...
                                            <?php //debug($art);//die; 
                                            foreach($Article as $g=>$lis ){
                                                foreach($lis['Lignelignecollection'] as $i=>$li )
                                               {
                                                //debug($li['Article']['famille_id']);die;
                            ...
                            <div class="ls-image-fluid-box">
                                            ...
                                            <a href="<?php echo $this->webroot;?>files/reference/<?php echo $li['Article']['image']; ?>" title="" data-fluidbox class="col-1">
                                                     <img src="<?php echo $this->webroot;?>files/reference/<?php echo $li['Article']['image']; ?>" width="30" height="30"/>
