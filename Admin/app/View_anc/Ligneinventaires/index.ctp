...
<div class="row">
	...
	<tr>
		...
		<th><?php echo $this->Paginator->sort('Paquet'); ?></th>
			<th class="actions" align="center"></th>
        </tr></thead><tbody>
	<?php foreach ($ligneinventaires as $ligneinventaire): ?>
	<tr>
		<td><?php echo h($ligneinventaire['Ligneinventaire']['id']); ?>&nbsp;</td>
		<td >
		...
		<td><?php echo h($ligneinventaire['Ligneinventaire']['qte']); ?>&nbsp;</td>
		<td><?php echo h($ligneinventaire['Ligneinventaire']['paquet']); ?>&nbsp;</td>
		<td align="center">
