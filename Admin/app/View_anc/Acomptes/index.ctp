...
<!--                                    <ul class="panel-control">
		...
		echo $this->Form->input('personnel_id',array('value'=>$personnel_id,'empty'=>'Veuillez Choisir','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
                ...
                echo $this->Form->input('annee_id',array('value'=>$annee_id,'empty'=>'Veuillez Choisir','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
                                     ?>                 
                            ...
                            <a onClick="flvFPW1(wr+'Acomptes/imprimerrecherche?annee_id=<?php echo $annee_id;?>&moi_id=<?php echo $moi_id;?>&personnel_id=<?php echo $personnel_id;?>&Date_debut=<?php echo @$Date_debut;?>&Date_fin=<?php echo @$Date_fin;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
                            </div>
                        </div> 
                            </div>
                        </div>
