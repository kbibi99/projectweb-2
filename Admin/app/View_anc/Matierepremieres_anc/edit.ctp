...
<div class="row" >
		...
		echo $this->Form->input('prixachat',array('div'=>'form-group','label'=>'Prix achat','type' => 'text', 'between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );
		echo $this->Form->input('stockalert',array('div'=>'form-group','label'=>'Stock alerte','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );
