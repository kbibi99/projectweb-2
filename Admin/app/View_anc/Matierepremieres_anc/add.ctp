...
<div class="row" >
		...
		echo $this->Form->input('prixachat',array('div'=>'form-group','label'=>'Prix achat','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );
