...
<div class="row" >
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Modification Sortie caisses'); ?></h3>
                                </div>
		...
		echo $this->Form->input('typedecaissement_id',array('div'=>'form-group','name'=>'data[Sortiecaiss][base]','id'=>'base','between'=>'<div class="col-sm-10">','empty'=>'Veuillez choisir','after'=>'</div>','class'=>'select') );
                ?>
              	...
              	<?php
		echo $this->Form->input('typedecaissement_id',array('div'=>'form-group','name'=>'data[Sortiecaiss][new]','id'=>'new','value'=>'','between'=>'<div class="col-sm-10">','empty'=>'Veuillez choisir','type'=>'text','after'=>'</div>','class'=>'form-control') );
                ?>
                ...
                $date2 = explode('-', $this->request->data['Sortiecaiss']['date']);
