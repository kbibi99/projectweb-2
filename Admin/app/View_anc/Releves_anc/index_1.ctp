...
<!--		<th><?php echo ('Client'); ?></th>-->
	...
	<?php $solde=0; $totremise=0;$totBL=0; $totREG=0; 
        if(!empty($releves)){
        foreach (@$releves as $relefe):
            ...
            ?>
	<tr>
                <td <?php echo $cadreB ?>align="center"><?php echo h($relefe['Relefe']['Type']) ;echo h($relefe['Relefe']['Numero']); ?></td>
...
<!--		<td><?php echo h($relefe['Relefe']['Client']); ?></td>-->
		<td <?php echo $cadreB ?> align="center"><?php echo h($relefe['Relefe']['Contact']); ?></td>
		<td <?php echo $cadreB ?>  align="right"><?php echo h($montant); ?></td>
                <td <?php echo $cadreB ?>  align="right"><?php echo h($acompte); ?></td>
		<td <?php echo $cadreB ?> align="right"><?php echo h($relefe['Relefe']['Remise']); ?></td>
                <td <?php echo $cadreB ?>align="right"><?php echo h($solde); ?></td>
...
<?php endforeach; 
        ...
        <tr>     
            <td colspan="6" align="right">Total Bon Livraison</td>
            <td  align="right"><?php echo h($totBL); ?></td>
        </tr>
        <tr>     
            <td colspan="6" align="right">Total Remise</td>
            <td  align="right"><?php echo h($totremise); ?></td>
        </tr>
        <tr>     
            <td colspan="6" align="right">Total Reglement</td>
            <td  align="right"><?php echo h($totREG); ?></td>
        </tr>

        <tr>     
            <td colspan="6" align="right">Total Solde</td>
