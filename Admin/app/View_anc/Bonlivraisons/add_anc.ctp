                                    ...
                                    <div class="table-responsive ls-table">
                                     <table id="table" class="table" >
                                            ...
                                            <tr >
                                                ...
                                                <td   align="center"><input name='data[Lignebonlivraison][<?php echo $i;?>][Qte]' index='<?php echo $i;?>' id='Qte<?php echo $i;?>' value="<?php echo $li[0]['qte'];?>" class="form-control calcule" readonly="readonly"></td>
