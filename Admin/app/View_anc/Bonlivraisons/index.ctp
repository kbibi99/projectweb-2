        ...
        ?>
                ...
                <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                ...
                                                <a href="<?php echo $this->webroot;?>bonlivraisons/index" class="btn btn-primary">Afficher Tout</a>
             <a  onClick="flvFPW1(wr+'Bonlivraisons/imprimerrecherche?marque_id=<?php echo @$marque_id;?>&client_id=<?php echo @$client_id;?>&Date_debut=<?php echo @$Date_debut;?>&Date_fin=<?php echo @$Date_fin;?>&numbl=<?php echo @$numbl ?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
<?php 
// debug($mar);
...
<?php echo $this->Form->end();?>
	...
	<tr>
		...
		<td align="center">
			...
			<?php $bonlivraison_delete=  CakeSession::read('bonlivraison_delete'); 
                                if($bonlivraison_delete==1){
