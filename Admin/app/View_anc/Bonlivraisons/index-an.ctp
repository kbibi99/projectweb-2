...
<?php echo $this->Form->end();?>
	...
	<tr>
		...
		<td align="center">
			...
			<?php 
                                $bonlivraison_edit=  CakeSession::read('bonlivraison_edit'); 
                                if($bonlivraison_edit==1){       
                                echo $this->Html->link("<button class='btn btn-xs btn-warning'><i class='fa fa-edit'></i></button>", array('action' => 'edit', $bonlivraison['Bonlivraison']['id']),array('escape' => false));
                                } ?>
