        ...
        ?>
                ...
                <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                ...
                                                <a href="<?php echo $this->webroot;?>Entreecaisses/liste_valide" class="btn btn-primary">Afficher Tout</a>
                           <a onClick="flvFPW1(wr+'Entreecaisses/imprimerliste_valide?Type=<?php echo @$Type;?>&client_id=<?php echo @$client_id;?>&Date_debut=<?php echo @$Date_debut;?>&Date_fin=<?php echo @$Date_fin;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
<?php 
// debug($mar);
...
<?php echo $this->Form->end();?>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo __('Les caisses valides'); ?></h3>
            </div>
