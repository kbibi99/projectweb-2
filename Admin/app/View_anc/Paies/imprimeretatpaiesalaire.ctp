...
$tbl .= '
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   ...
   <tr bgcolor="#FFFFFF" align="center">
        <th width="6%" align="center" $zz ><strong> رقم </strong></th>
        ...
        foreach ($paies as $paie){
            ...
            if($i==12){
                ...
                // <th width="6%" align="center" $zz style="display: none"><strong> رقم </strong></th>
                // $pdf->AddPage();
            ...
            $tot_dim=$tot_dim+sprintf("%01.3f",$MD);
            $tot_mnt=$tot_mnt+sprintf("%01.3f",$Mjh);
            $tot_b=$tot_b+sprintf("%01.3f",$paie['Paie']['Salairebase']);
            $tot_sal=$tot_sal+sprintf("%01.3f",$paie['Paie']['Totalpaie']);
            $tot_ac=$tot_ac+sprintf("%01.3f",$paie['Paie']['acompte']);
            $tot_mp=$tot_mp+sprintf("%01.3f",$paie['Paie']['Donne']);
            
            $tot_dim=  sprintf('%.3f',$tot_dim);
            $tot_mnt=  sprintf('%.3f',$tot_mnt);
            $tot_b=  sprintf('%.3f',$tot_b);
            $tot_ac=  sprintf('%.3f',$tot_ac);
            $tot_sal=  sprintf('%.3f',$tot_sal);
    ...
    '<tr bgcolor="#FFFFFF" align="center">   
        ...
        <td width="11%" nobr="nobr" align="center"  '.$style.'>'.sprintf("%01.3f",$paie['Paie']['Salairebase']).'</td>
        ...
        <td width="11%" nobr="nobr" align="center"  '.$style.'>'.sprintf("%01.3f",$MD).'</td>
        <td width="11%" nobr="nobr" align="center"  '.$style.'>'.sprintf("%01.3f",$paie['Paie']['acompte']).'</td>
        <td width="11%" nobr="nobr" align="center"  '.$style.'>'.sprintf("%01.3f",$paie['Paie']['Totalpaie']).'</td>
        <td width="11%" nobr="nobr" align="center"  '.$style.'>'.sprintf("%01.3f",$paie['Paie']['Donne']).'  </td>
  </tr>' ;   
    }
   $tbl .= 
    '<tr bgcolor="#FFFFFF" align="center">
        <td colspan="2" align="center" height="30px"><strong> Total</strong></td>
        <td width="11%" nobr="nobr" align="center"  ><strong>'.$tot_b.'</strong></td>
        <td width="8%" nobr="nobr" align="center"  ><strong></strong></td>
        <td width="11%" nobr="nobr" align="center"  ><strong>'.$tot_mnt.'</strong></td>
        <td width="8%" nobr="nobr" align="center"  ><strong></strong></td>
        <td width="11%" nobr="nobr" align="center"  ><strong>'.$tot_dim.'</strong></td>
