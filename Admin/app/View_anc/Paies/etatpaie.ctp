...
<div class="row">
                  ...
                  <table class="table table-bordered table-striped table-bottomless" id="ls-editable-table">
                      <thead>
	<tr>     
            <th style="display: none"><?php echo 'Code' ;?></th>
	...
	<?php foreach ($personnel as $person): 
           // debug($abc[$person['Personnel']['id']][1])
            ...
            ?>
	<tr>
            <td style="display: none"><?php echo $person['Personnel']['Code'];?>  </td>
            <td> <?php echo $this->Html->link($person['Personnel']['name'], array('controller' => 'personnels', 'action' => 'view', $person['Personnel']['id'])); ?></td>
