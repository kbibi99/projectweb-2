...
<div class="row">
	...
	<tr>
		<td><?php echo h($utilisateurmenu['Utilisateurmenu']['id']); ?>&nbsp;</td>
		<td >
		...
		<td >
			<?php echo $this->Html->link($utilisateurmenu['Menu']['id'], array('controller' => 'menus', 'action' => 'view', $utilisateurmenu['Menu']['id'])); ?>
		</td>
		<td align="center">
