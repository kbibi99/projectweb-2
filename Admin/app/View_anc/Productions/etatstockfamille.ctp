...
?>
       ...
       <a  onClick="flvFPW1(wr+'Productions/imprimeretatstock?marque_id=<?php echo @$marque_id;?>&famille_id=<?php echo @$famille_id;?>&Date_debut=<?php echo @$Date_debut;?>&Date_fin=<?php echo @$Date_fin;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
