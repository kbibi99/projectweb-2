...
<div class="row">
	...
	<tr>
		...
		<td><?php echo h(date('d/m/Y', strtotime(str_replace('-', '/',$production['Production']['date'])))); ?></td>
		...
		<td align="center">
			...
			<?php echo $this->Html->link("<button class='btn btn-xs btn-warning'><i class='fa fa-dropbox'></i></button>", array('action' => 'production', $production['Production']['id']),array('escape' => false)); ?>
                ...
                <td align="center"><a onClick="flvFPW1(wr+'productions/imprimerrecherche/<?php echo $production['Production']['id'];?>/<?php echo $production['Production']['date'];?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a></td>
