...
?>
                ...
                <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3" >
                                                ...
                                                <a href="<?php echo $this->webroot;?>productions/etatstockfamille" class="btn btn-primary">Afficher Tout</a>
       <a  onClick="flvFPW1(wr+'Productions/imprimeretatstock?marque_id=<?php echo @$marque_id;?>&famille_id=<?php echo @$famille_id;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
...
<?php echo $this->Form->end();?>
	...
	<tr>
                ...
                <td align="center" ><?php echo ('Quantité'); ?></td>
                <td align="center" ><?php echo ('Quantité  Pair'); ?></td>
                <td align="center" ><?php echo ('Valeur ')?></td>
	...
	<tr>
		...
		<td><?php echo h($famille['Famille']['name']); ?></td>
                ...
                <td align="right"><?php echo h($qteR)?></td>
                <td align="right"><?php echo h($qte_pair)?></td>
...
<?php endforeach;
        ...
        <tr>
                ...
                <td align="right" colspan="4">Valeur total</td>
                <td align="right"><?php echo h(sprintf('%.3f',$somme)); ?></td>
