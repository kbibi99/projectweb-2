    ...
    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Consultation Devi'); ?></h3>
                                </div>
         ...
         <?php echo $this->Form->create('Devi',array('autocomplete' => 'off','class'=>'form-horizontal ls_form','id'=>'defaultForm','data-bv-message'=>'This value is not valid','data-bv-feedbackicons-valid'=>'fa fa-check','data-bv-feedbackicons-invalid'=>'fa fa-bug','data-bv-feedbackicons-validating'=>'fa fa-refresh')); ?>
           ...
           <div class="col-md-6">                         
			...
			<div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo h($devi['Devi']['id']); ?>'>
			...
			<div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo h($devi['Devi']['Numero']); ?>'>
                                 ...
                                 <label class='col-md-2 control-label'><?php echo __('Client'); ?></label>	
                                  ...
                                  <div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' value='<?php echo $devi['Client']['id']; ?>'>
                                  </div>
			...
			<div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo h($devi['Devi']['Total_HT']); ?>'>
			...
			<div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo h($devi['Devi']['Remise']); ?>'>
			...
			<div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo h($devi['Devi']['Tva']); ?>'>
			...
			<div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo h($devi['Devi']['Total_TTC']); ?>'>
                                 ...
                                 <label class='col-md-2 control-label'><?php echo __('Timbre'); ?></label>	
                                  ...
                                  <div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' value='<?php echo $devi['Timbre']['name']; ?>'>
                                  </div>
                                 ...
                                 <label class='col-md-2 control-label'><?php echo __('Utilisateur'); ?></label>	
                                  ...
                                  <div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' value='<?php echo $devi['Utilisateur']['id']; ?>'>
                                  </div>
                                 ...
                                 <label class='col-md-2 control-label'><?php echo __('Ligneclient'); ?></label>	
                                  ...
                                  <div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' value='<?php echo $devi['Ligneclient']['name']; ?>'>
                                  </div>
