...
<div class="row">
	...
	<tr>
		<td><?php echo h($lignereglement['Lignereglement']['id']); ?>&nbsp;</td>
		<td >
			<?php echo $this->Html->link($lignereglement['Reglement']['id'], array('controller' => 'reglements', 'action' => 'view', $lignereglement['Reglement']['id'])); ?>
		</td>
		<td >
			<?php echo $this->Html->link($lignereglement['Piecereglement']['id'], array('controller' => 'piecereglements', 'action' => 'view', $lignereglement['Piecereglement']['id'])); ?>
		</td>
		<td><?php echo h($lignereglement['Lignereglement']['type']); ?>&nbsp;</td>
