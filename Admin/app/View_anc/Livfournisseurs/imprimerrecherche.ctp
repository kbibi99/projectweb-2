 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr bgcolor="#FFFFFF" align="center">
    ...
    '<tr bgcolor="#FFFFFF" align="center">    
        ...
        <td width="33%" nobr="nobr" align="center"  $zz>'.date("d/m/Y",strtotime(str_replace('-','/',$bc['Livfournisseur']['Date']))).'</td>
        <td width="33%" nobr="nobr" align="center"  $zz>'.$bc['Livfournisseur']['Numero'].'</td>
    </tr>' ;     
}
