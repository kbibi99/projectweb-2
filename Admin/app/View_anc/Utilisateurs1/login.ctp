<!--<div class="loginWrapper">
	<div class="loginLogo1"><?php echo $this->Html->image('logistiaue.png'); ?></div>
        ...
        <div class="head"><h5 class="iUser">Login</h5></div>
            ...
            <fieldset>
                <div class="loginRow">
                    ...
                    <div class="loginInput"><input type="text" name="login" value="" class="validate[required]" id="req1" /></div>
                    <div class="fix"></div>
                </div>
                
                <div class="loginRow">
                    <label for="req2">Mot de passe:</label>
                    <div class="loginInput"><input type="password" name="password" value="" class="validate[required]" id="req2" /></div>
                    <div class="fix"></div>
                </div>
                
                <div class="loginRow">
                    <input type="submit" value="Login" class="basicBtn submitForm" />
                    <div class="fix"></div>
                </div>
            </fieldset>
                ...
                <div class="login-box">
                    <div class="login-content">
                        <div class="login-user-icon">
                            <i class="glyphicon"><img src="<?php echo $this->webroot;?>assets/images/petit-logo.png" alt="" style="vertical-align: top !important"/></i>
...
<!--                            <ul>
 ...
 <?php echo $this->Form->create('Utilisateur',array('class'=>'mainForm','autocomplete'=>'off'));?>
   ...
   <p class="copy-right big-screen hidden-xs hidden-sm">
        <span>&#169;</span> MTD application <span class="footer-year">2014</span>
    </p>
</section>
