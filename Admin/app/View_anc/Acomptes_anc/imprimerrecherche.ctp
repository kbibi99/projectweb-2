...
//$m=' du  '.$deb.' au  '.$fn;
//}
$pdf->SetHeaderData('BLUE.png', '30', '                                                                                Listes des Acomptes '.$mm .' '.$aa);
...
<thead>      
    ...
    <tr bgcolor="#FFFFFF" align="center">
        <th width="20%" align="center" $zz >Personnel</th>
        <th width="20%" align="center" $zz >Mois</th>
        <th width="20%" align="center" $zz >Annee</th>
        <th width="20%" align="center" $zz >Montant</th>
        <th width="20%" align="center" $zz >Date</th>
    </tr>
    </thead>';
