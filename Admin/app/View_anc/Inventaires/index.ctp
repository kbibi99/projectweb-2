<?php
$inventaireS_add=  CakeSession::read('inventaireS_add'); 
if($inventaireS_add==1){
?>
<div class="row">
    <div class="col-md-12">
...
<div class="row">
	...
	<tr>
		...
		<td align="center">
			...
			<?php if($k==$c){?>
			<?php 
                        $inventaireS_edit=  CakeSession::read('inventaireS_edit'); 
                                if($inventaireS_edit==1){
                        echo $this->Html->link("<button class='btn btn-xs btn-warning'><i class='fa fa-edit'></i></button>", array('action' => 'edit', $inventaire['Inventaire']['id']),array('escape' => false)); 
                                }$inventaireS_delete=  CakeSession::read('inventaireS_delete'); 
                            if($inventaireS_delete==1){
