...
//          debug($articles);die;
         $this->request->data['Inventaire']['Date']=date("d/m/Y",strtotime(str_replace('-','/',$this->request->data['Inventaire']['Date'])));
		...
		echo $this->Form->input('num',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','label'=>'Numéro','required data-bv-notempty-message'=>'Champ Obligatoire','readonly') );
		echo $this->Form->input('depot_id',array('div'=>'form-group','label'=>'Dépôt','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','empty'=>'Veuillez choisir') );
	?></div><div class="col-md-6"><?php
		echo $this->Form->input('Date',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly','type'=>'text','required data-bv-notempty-message'=>'Champ Obligatoire') );
                echo $this->Form->input('marque_id',array('div'=>'form-group','label'=>'Dépôt','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','empty'=>'Veuillez choisir','disabled'=>'disabled') );
                                           ...
                                           ?>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($value['Article'] as $key1 =>$value1 ) {
                                                    //debug($this->request->data['Ligneinventaire']);die;
                                                    $paquet=0;
                                                    $qte=0;
                                                    foreach ($this->request->data['Ligneinventaire'] as $ligne ) {
...
//debug($value1);die;?>
                                                ...
                                                <td style="border: 1px solid #ddd !important;"><input type="text" class="form-control paq" id="<?php echo $key?>paq<?php echo $key1?>" name="data[Ligneinventaire][<?php echo $n; ?>][paquet]" index="paq" fam="<?php echo $key?>" lig="<?php echo $key1?>" value="<?php echo $paquet; ?>"   ></td>
                                                <td style="border: 1px solid #ddd !important;"><input type="text" class="form-control qte" id="<?php echo $key?>qte<?php echo $key1?>" name="data[Ligneinventaire][<?php echo $n; ?>][qte]" index="qte" fam="<?php echo $key?>" lig="<?php echo $key1?>" value="<?php echo $qte; ?>"></td>
                                            </tr>
