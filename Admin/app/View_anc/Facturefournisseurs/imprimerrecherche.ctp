...
$pdf->SetHeaderData('BLUE.png', '60', '          Liste Facture Fournisseur    '.$m);
   ...
   <tr bgcolor="#FFFFFF" align="center">
       ...
       foreach ($facturefournisseurs as $bc){
          ...
          if($bc['Facturefournisseur']['Type']=="0"){
            ...
            $cadreB='style="background-color:#D0DCE3;"';
            }
               
        $tbl .= 
    '<tr bgcolor="#FFFFFF" align="center">    
        <td width="34%" nobr="nobr" align="center" height="30px" $zz '.$cadreB.'>'.$bc['Fournisseur']['raison_social'].'</td>
        <td width="33%" nobr="nobr" align="center"  $zz '.$cadreB.'>'.date("d/m/Y",strtotime(str_replace('-','/',$bc['Facturefournisseur']['Date']))).'</td>
        <td width="33%" nobr="nobr" align="center"  $zz '.$cadreB.'>'.$bc['Facturefournisseur']['Numero'].'</td>
    </tr>' ;     
}
...
ob_end_clean();
$pdf->Output('liste_facture_fournisseur.pdf', 'I');
