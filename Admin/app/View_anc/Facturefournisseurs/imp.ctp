...
$pdf->SetHeaderData("petit-logo.png",50,'           Facture fournisseur ');
...
foreach ($reqfournisseur as $k=>$var_ligne) {  
    //debug($reqfournisseur);die;
              ...
              $date=date("d/m/Y",strtotime(str_replace('-','/',$reqfournisseur['Facturefournisseur']['Date'])));  
              $num=$reqfournisseur['Facturefournisseur']['Numero'];   
} 
$tbl = $tbl . <<<EOF
...
//            $timbre=0;
              ...
              $gtva=$reqfournisseur['Facturefournisseur']['Tva']; 
              $grem=$reqfournisseur['Facturefournisseur']['Remise']; 
              $ght=$reqfournisseur['Facturefournisseur']['Total_HT']; 
              $gtim=$reqfournisseur['Facturefournisseur']['timbre']; 
              $gttc=$reqfournisseur['Facturefournisseur']['Total_TTC']; 
              
          foreach ($lignes as $k=>$lignestock){ 
              $code=$lignestock['Mpfournisseur']['Matierepremiere']['nom2'];   
              $qte=$lignestock['Lignefacturefournisseur']['Qte'];
              $qte2=number_format($qte,3);
              $prix=$lignestock['Lignefacturefournisseur']['Prix'];
              $prix2=number_format($prix,3);
              $rem=$lignestock['Lignefacturefournisseur']['Remise'];
              $rem2=number_format($rem,3);
              $tva=$lignestock['Lignefacturefournisseur']['Tva']; 
              $ht=$lignestock['Lignefacturefournisseur']['Total_HT'];
