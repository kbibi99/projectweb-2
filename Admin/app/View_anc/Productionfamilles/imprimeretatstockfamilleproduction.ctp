...
$tbl .= '
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
    ...
    <tr bgcolor="#FFFFFF" align="center">
        ...
        <th width="10%" align="center" $zz ><strong>Prix</strong></th>
        <th width="10%" align="center" $zz ><strong>Stock unitial</strong></th>
        <th width="14%" align="center" $zz ><strong>Production</strong></th>
        <th width="13%" align="center" $zz ><strong>Vente</strong></th>
        <th width="10%" align="center" $zz ><strong>Stock</strong></th>
        <th width="15%" align="center" $zz ><strong>Valeur Stock</strong></th>
    </tr>';
...
//                 ---------- Supp Decalage entre l en Tete et Le Tableau ------------
        ...
        $tbl .= 
    '<tr bgcolor="#FFFFFF" align="center">    
        <td width="28%"  height="30px" nobr="nobr" align="center"  $zz>'.$name.'</td>
        <td width="10%" nobr="nobr" align="center"  $zz>'.$prixFam.'</td>
        <td width="10%" nobr="nobr" align="center"  $zz>'.$qte_packet.'</td>
        <td width="14%" nobr="nobr" align="center"  $zz>'.$qte_liv.'</td>
        <td width="13%" nobr="nobr" align="center"  $zz>'.$qteBL.'</td>
        <td width="10%" nobr="nobr" align="center"  $zz>'.$qteR.'</td>
        <td width="15%" nobr="nobr" align="right"  $zz>'.$prix.'</td>
    </tr>' ;   
...
$tbl .= '
    <tr bgcolor="#FFFFFF" align="center">  
        <td width="38%" height="30px" nobr="nobr" align="right" colspan="2"   $zz><strong>Total</strong></td>
        <td width="10%" nobr="nobr" align="center"  $zz><strong>'.$sommeqte.'</strong></td>
        <td width="14%" nobr="nobr" align="center"  $zz><strong>'.$somPRO.'</strong></td>
        <td width="13%" nobr="nobr" align="center"  $zz><strong>'.$somVEN.'</strong></td>
        <td width="10%" nobr="nobr" align="center"  $zz><strong>'.$somSTK.'</strong></td>
        <td width="15%" nobr="nobr" align="right"  $zz><strong>'.$somme.'</strong></td>
    </tr>
</table>';
