...
$pdf->SetHeaderData('BLUE.png', '60', '        Etat Production / Jour    '.$m);
...
$tbl .= '
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr bgcolor="#FFFFFF" align="center">
        <th width="60%" align="center" $zz height="30px" ><strong>Date</strong></th>
        <th width="40%" align="center" $zz ><strong>Quantité</strong></th>
  </tr>';
        $s=1;
        $sqte=0;
        $i=0;
...
//            }
           ...
           if($ligneproduction['Productionfamille']['date']!=$nbl){
             ...
             $tbl .=' <tr>
                  <td height="35px" align="center">Total        '.$nnbl.'</td>
                  <td  align="center">'.$sqte.'</td>
              </tr>';
...
$tbl .= '
   <tr bgcolor="#FFFFFF" align="center">    
        ...
        <td width="60%" height="35px"  nobr="nobr" align="center"  $zz>'.Total.'  '.date('d/m/Y', strtotime(str_replace('-', '/',$ligneproduction['Productionfamille']['date']))).'</td>
        <td width="40%" nobr="nobr"  align="center"  $zz>'.$sqte.'</td>
    </tr>
</table>';
