...
?>
       ...
       <a  onClick="flvFPW1(wr+'Productionfamilles/imprimeretatproddate?famille_id=<?php echo @$famille_id;?>&Date_debut=<?php echo @$Date_debut;?>&Date_fin=<?php echo @$Date_fin;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
...
<?php echo $this->Form->end();?>
    ...
    <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Etat Production / Jour'); ?></h3>
                                </div>
                                <div class="panel-body">
	...
	<?php 
        ...
        foreach ($ligneproductions as $ligneproduction): 
           if($ligneproduction['Productionfamille']['date']!=$nbl){
               $s=1;?>
              <tr>
                  <td  align="center"><strong>Total <?php echo date('d/m/Y', strtotime(str_replace('-', '/',$nbl))); ?></strong></td>
                  <td  align="center"><strong><?php echo h($sqte)?></strong></td>
              </tr>
              <?php 
              $sqte=0;
	...
	<tr>
            ...
            <td align="center" style="display: none"><?php echo h(date('d/m/Y', strtotime(str_replace('-', '/',$ligneproduction['Productionfamille']['date'])))); ?></td>
            <td align="center" style="display: none"><?php echo h($ligneproduction['Famille']['name'])?></td>
            <td align="center" style="display: none"><?php echo h($ligneproduction[0]['qte'])?></td>
...
?>
                <tr>
                  <td  align="center"><strong>Total <?php echo h(date('d/m/Y', strtotime(str_replace('-', '/',$ligneproduction['Productionfamille']['date']))))?></strong></td>
                  <td  align="center"><strong><?php echo h($sqte);?></strong></td>
              </tr>
