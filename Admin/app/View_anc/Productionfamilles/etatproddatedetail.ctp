...
?>
                ...
                <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3" >
                                                ...
                                                <a href="<?php echo $this->webroot;?>Productionfamilles/etatproddate" class="btn btn-primary">Afficher Tout</a>
       <a  onClick="flvFPW1(wr+'Productionfamilles/imprimeretatproddatedetail?famille_id=<?php echo @$famille_id;?>&Date_debut=<?php echo @$Date_debut;?>&Date_fin=<?php echo @$Date_fin;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
...
<?php echo $this->Form->end();?>
    ...
    <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Etat Production / Jour Avec Detail'); ?></h3>
                                </div>
                                <div class="panel-body">
                  ...
                  <table class="table table-bordered table-striped table-bottomless" id="">
                      <thead>
	<tr>
            <td align="center" ><strong><?php echo ('Date'); ?></strong></td>
            <td align="center" ><strong><?php echo ('Famille'); ?></strong></td>
            <td align="center" ><strong><?php echo ('Quantite'); ?></strong></td>
                
        </tr></thead><tbody>
	<?php 
        //debug($ligneproductions[0]['Productionfamille']['date']);die;
        $s=1;
        $sqte=0;
        if(!empty($ligneproductions)){
        ...
        foreach ($ligneproductions as $ligneproduction): 
           if($ligneproduction['Productionfamille']['date']!=$nbl){
               $s=1;?>
              <tr>
                  <td colspan="2" style="background-color:  #f8b9b7" align="center"><strong>Total <?php echo date('d/m/Y', strtotime(str_replace('-', '/',$nbl))); ?></strong></td>
                  <td style="background-color:  #1FD9D0" align="center"><strong><?php echo h($sqte)?></strong></td>
              </tr>
              <?php 
              $sqte=0;
	...
	<tr>
                ...
                <td align="center"><?php echo h(date('d/m/Y', strtotime(str_replace('-', '/',$ligneproduction['Productionfamille']['date'])))); ?></td>
                <td align="center"><?php echo h($ligneproduction['Famille']['name'])?></td>
                <td align="center"><?php echo h($ligneproduction[0]['qte'])?></td>
...
?>
                <tr>
                  <td colspan="2" style="background-color:  #f8b9b7" align="center"><strong>Total <?php echo h(date('d/m/Y', strtotime(str_replace('-', '/',$ligneproduction['Productionfamille']['date']))))?></strong></td>
                  <td style="background-color:  #1FD9D0" align="center"><strong><?php echo h($sqte);?></strong></td>
              </tr>
