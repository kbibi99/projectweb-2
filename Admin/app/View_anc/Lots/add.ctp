    ...
    <div class="col-md-12" >
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo __('Ajout Lot'); ?></h3>
            </div>
                                       ...
                                       <?php  foreach ($matierepremiere as $key =>$value ) { ?>
                                                <tr>
                                                    <td style="border: 1px solid #ddd !important;"><?php echo $value['Matierepremiere']['designation']?>
                                                        <input type="hidden"  id="<?php echo $key?>id<?php echo $value['Matierepremiere']['id']?>" name="data[Lignelot][<?php echo $n; ?>][matierepremiere_id]"   value="<?php echo $value['Matierepremiere']['id']?>"  ></td>
                                                    ...
                                                    <td style="border: 1px solid #ddd !important;"><input type="text" class="form-control quantite"  id ="qte_inventory" name="data[Lignelot][<?php echo $n; ?>][qte_piece]" index="qte_piece"></td>
